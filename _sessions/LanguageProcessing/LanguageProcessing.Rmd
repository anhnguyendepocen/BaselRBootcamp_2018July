---
title: "Natural language processsing"
...
|   `str_extract` | Extractt strings matching pattern. |
...
<p align="center">
  <img src="image/starks.png" height="450px"></img><br>
</p>
...
<high>Human judgment</high><br> Identify words that were judged by humans based on their sentimenta and aggregate the values.

<high>Heuristic rules</high><br> Completements the first approach with rules, e.g., negation. 
...
<img src="image/sentiment_got.png" width="550">
