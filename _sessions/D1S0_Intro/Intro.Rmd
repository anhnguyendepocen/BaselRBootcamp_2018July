...
We all have different backgrounds and learn at different speeds

Best way to learn? Try, Struggle, Get help, Try, Struggle, Get Help (repeat)

Ask questions! We're here to help (but we won't make it too easy for you)

You'll never master a language (certainly not in 2 weekends), you'll always be learning.

Have fun and keep it light, learning a programming language should be (often) fun!
...
knitr::include_graphics("https://github.com/therbootcamp/therbootcamp.github.io/blob/master/_sessions/_image/session_breakdown.png?raw=true")
```
...
30 - 60 minute slide based introduction
...
### Be interactive!!
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/therbootcamp/therbootcamp.github.io/blob/master/_sessions/_image/lecture_questions.png?raw=true")
```
...
Anywhere from 10 ~ 30 programming tasks. Starts easy, gets progressively more challenging
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/therbootcamp/therbootcamp.github.io/blob/master/_sessions/_image/practical_emojis.png?raw=true")
```
...
We'll find some space and help you with whatever you're struggling with
...
```{r, echo = FALSE}
knitr::include_graphics("https://github.com/therbootcamp/therbootcamp.github.io/blob/master/_sessions/_image/coaching_15.png?raw=true")
```
