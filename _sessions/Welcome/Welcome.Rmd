...
<center><font size = 4>Source: Wikipedia</font></center>
]
---
...
We have a very intense and ambitious schedule!

The amount of material we will be covering in two short weekends is...crazy

3 days, 3 sessions per day, 2 hours per session

Eacon session contains a slide-based introduction and a hands-on practical
...
Links are in [pink](http://therbootcamp.github.io)
...
```{r, out.width = "50%", echo = FALSE, fig.cap = "Freepik.com"}
...
This is where you really learn how to program!
...
You will **not** be able to finish all of the tasks. That's ok!
...
<br>
```{r, echo = FALSE, fig.cap = "<font size = 4>Source: repairedcomputer.com</font>", out.width = "70%"}
knitr::include_graphics("http://www.repairedcomputer.com/i/68/c/14/quality-computer-repair.1360h.jpg")
```


```{r, echo = FALSE, out.width = "70%", fig.cap = "<font size = 4>Source: University of Southampton</font>"}
