...
<center><font size = 4>Wikipedia</font></center>
]
---
...
<br>
```{r, out.width = "45%", echo = FALSE, fig.cap = "<font size = 4>Freepik.com</font>"}
...
<br>
```{r, echo = FALSE, fig.cap = "<font size = 4>repairedcomputer.com</font>", out.width = "70%"}
knitr::include_graphics("http://www.repairedcomputer.com/i/68/c/14/quality-computer-repair.1360h.jpg")
```


```{r, echo = FALSE, out.width = "70%", fig.cap = "<font size = 4>University of Southampton</font>"}
