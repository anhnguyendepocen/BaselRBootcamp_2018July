...
>>>>>>> be0fb9a08eeaf3d50b46b3fffb3456358c84a209
...
<<<<<<< HEAD
4 - <high>Common methods</high> to explore statistical objects
- `print()`, `summary()`, `names()`, `predict()`, `plot()`

5 - <high>Dissect</high> statistical objects <high>with `$`</high>

6 - Work with R's library of <high>statistical distributions</high>
- `rnorm()`, `runif()`
=======
...
<<<<<<< HEAD
Apply a statistical function `STAT_FUN` with the `formula` and `data` arguments:
