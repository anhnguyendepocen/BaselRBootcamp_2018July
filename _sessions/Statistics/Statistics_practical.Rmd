...
|:----|:-----|:------|:-----------------------------------------|
|[kc_house.csv](https://raw.githubusercontent.com/therbootcamp/BaselRBootcamp_2018July/master/_sessions/_data/complete/kc_house.csv) | 21613 | 21|House sale prices for King County between May 2014 and May 2015. |
...
1. Open your R project. It should already have the folders `1_Data` and `2_Code`. Make sure that all of the data files listed above are contained in the `1_Data` folder
