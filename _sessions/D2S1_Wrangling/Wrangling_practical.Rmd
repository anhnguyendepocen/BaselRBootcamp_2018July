...
# Save a copy of the ChickWeight data (already in R) as chick
chick <- as_tibble(ChickWeight) 
...
A. Open your workshop project. It should alreaduy have the folders `data` and `R`. Make sure that the `ACTG175.csv` is in the `data` folder
