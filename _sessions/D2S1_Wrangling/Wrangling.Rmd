...
.pull-right6[
<br>
<font size = 6>Here's how dplyr looks in action</font>
<br><br>
```{r, echo = FALSE, out.width = "100%", fig.align = 'center'}
...
<font size = 6>dplyr makes extensive use of the "Pipe" <b><font color='purple'>%>%</font></b></font><br><br>
...
```{r, echo = FALSE, out.width = "100%", fig.align = 'center'}
knitr::include_graphics("../_image/pipe_andthen.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("../_image/pipe_how_works.png")
```
...
> <font size = 5>Hey I need you do do some analyses on that survey data of <b>baselers</b> to understand the levels of income and debt of people younger than 40. First, I need you to <b>change the name</b> of the column 'age' to 'age_years' and 'weight' to 'weight_kg'. Next, <b>only include</b> people younger than 40. <b>Add a new column</b> called that shows people's debt divided by their income. Then, <b>create groups</b> based on sex, and <b>calculate</b> the mean income, debt, and debt ratio for each group. Thanks!! Should be easy right?</font>
...
<font size = 5>"Keep the pipe <font color = 'purple'>%>%</font> going" to continue working with your dataframe</font><br><br>

<font size = 5>Don't forget to assign your result to a new object to save it!</font><br><br>

<font size = 5>The output of dplyr functions will (almost) always be a tibble</font><br><br>

<font size = 5>You can almost always include multiple operations within each function</font><br><br>
...
<font size = 5> 1) Order of functions matters </font>
<br> <br>
<font size = 5> 2) You can refer to new objects in later code </font>
<br> <br>
<font size = 5> 3) To update a dataframe, make sure to assign it to itself with <- </font>
...
- Group data by arm
- Calculate summary statistics from time1 and time2
...
stock_w %>% 
  gather(time,    # New Group name
         measure, # New column name
         -id)     # ID column
```
...
stock_l %>% 
  spread(time,    # Old Group Name
         measure) # Old column Name
```
