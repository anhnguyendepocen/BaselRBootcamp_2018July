...
# Step 1) Read file called mydata.csv 
#  in a data folder with read_csv()
#  and save as new object trial_data

trial_data <- read_csv(file = "data/mydata.csv")

# Step 2) Explore data

View(trial_data)   # Open in new window
dim(trial_data)    # Show number of rows and columns
names(trial_data)  # Show names

# Step 3) Calculate descriptives on named colums

mean(trial_data$age)   # What is the mean age?
table(trial_data$sex)  # How many of each sex?
...
trial[trial$sex == "f" & trial$age > 50, 'id']
```
