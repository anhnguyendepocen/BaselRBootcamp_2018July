...
1. We have a new app template we'd like you to use. You can find it here (). Open this link and copy *all* of the code. Then, go back to your `app.R` file and delete *all* of the content in the file. After, paste all of the code you just copied.
...
1. Start by following the example above so you have your own `app.R`
