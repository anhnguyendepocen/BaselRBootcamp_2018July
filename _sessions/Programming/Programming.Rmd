...
Defining your own functions can save a lot of time and space. By writing your own function you only have to write the whole block of code once.
...
Functions can take any object as input to arguments. Also functions or expressions can be passed as arguments.
...
Possible functions are `stop()`, `warning()`, `message()`.

- With `stop()`, `warning()`, and `message()` you have to use separate `if` statements to test each potential violation. 
