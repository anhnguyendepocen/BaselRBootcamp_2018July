...
2. Open a new R script and save it as a new file called `Programming_in_R_practical.R` in the `2_Code` folder. At the top of the script, using comments, write your name and the date. The, load the set of packages listed above with `library()`.
