...
The `happiness` data contains `r ncol(happiness)` pieces of information for `r nrow(happiness)` countries. The data originally come from the World Happiness Report but were taken from [https://www.kaggle.com/unsdsn/world-happiness](https://www.kaggle.com/unsdsn/world-happiness). Here is a table showing a few columns from the data
