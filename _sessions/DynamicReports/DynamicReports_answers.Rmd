...
Here are the dataset(s) I will explore:
...
|`happiness.csv`| Country happiness statistics|`r nrow(happiness)`|`r ncol(happiness)`|
...
The `mcdonalds` data contains `r ncol(mcdonalds)` pieces of information for `r nrow(mcdonalds)` menu items. The data originally come from [Kaggle](https://www.kaggle.com/mcdonalds/nutrition-facts). Here is a table showing the first 6 columns in the data
