...
5. Now it's time to add an image to your document! In the chunk you just created, use the following template to include the McDonalds logo in your document. You can find the McDonalds logo on wikipedia at the following link: [https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/McDonald%27s_Golden_Arches.svg/2000px-McDonald%27s_Golden_Arches.svg.png](https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/McDonald%27s_Golden_Arches.svg/2000px-McDonald%27s_Golden_Arches.svg.png).

```{r, out.width = "30%", fig.cap="Source: Wikipedia", echo = TRUE, eval = FALSE}
# Include the McDonalds logo in my document
