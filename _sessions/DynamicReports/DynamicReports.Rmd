...
The `datatable()` function from the `DT` package will include a rich HTML table in your document. See [https://rstudio.github.io/DT/options.html](https://rstudio.github.io/DT/options.html) for customisation options

```{r}
library(DT)

datatable(baselers %>% select(id, sex, age, height, weight, income),
