...
1. Follow Steps 1 through 3 in the *Modelling Procedure* section above above to create your best decision tree model predicting `house_train$price`. Call the model `rpart_price`
...
4. Follow steps 4 and 5 to see which model did the best in *predicting* `house_test$price`

4. Which of the three models was the best at predicting price? Were they very different? Is one easier to interpret than the other?
