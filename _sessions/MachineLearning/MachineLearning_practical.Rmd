...
1. Fit a machine learning model to training data
2. Explore a machine learning object with generic functions
3. Predict outcomes from new data with the model
4. Evaluate a model's fitting and prediction performance.
5. Repeat all 4 steps with both a classification and regression task
...
|File | Rows | Columns |
|:----|:-----|:------|
|`attrition_train.csv` | 2139 | 27 |
|`attrition_test.csv` | 2139 | 27 |
|`heartdisease_train.csv` | 2139 | 27 |
|`heartdisease_test.csv` | 2139 | 27 |
|`house_train.csv`| 2139 | 3|
|`house_test.csv`| 2139 | 3|
