...
|`stores.csv` | 1115 | 10| Data about the individual stores of the retailer | [Download Link](https://raw.githubusercontent.com/therbootcamp/therbootcamp.github.io/master/_sessions/_data/stores.csv) |
...
2. Randomly sample two time points (use the `sample()` function for this) from the `days` variable created above, and run a correlation. 
