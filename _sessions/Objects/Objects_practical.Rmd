...
In this practical you'll learn how to work with R data objects. By the end of this practical you will know how to:
...
1. Open your R project. It should already have the folders `1_Data` and `2_Code`.

2. Open a new R script and save it as a new file called `objects_practical.R` in the `2_Code` folder. At the top of the script, using comments, write your name and the date. Then, load the set of packages listed above with `library()`.
