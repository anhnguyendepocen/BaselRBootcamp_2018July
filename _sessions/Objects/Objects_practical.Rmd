...
<<<<<<< HEAD
1. Using the `data.frame()` function, create a data frame called `ten_df` that contains each of vectors you just created: `id`, `sex`, `age`, `height`, `weight`, `tall_180`
=======
1. Using the `data.frame()` function, create a data frame called `ten_df` that contains each of vectors you just created: `id`, `sex`, `height`, `weight`, `tall_180` and `age`
>>>>>>> 823ea2f4d554cdf825fc0fe8d7064294f0dce3d8

```{r, eval = FALSE, echo = TRUE}
# Create data frame ten_df containing vectors id, sex, height, weight, and tall_180
XX <- data.frame(XX, XX, XX, XX, XX, XX) 
```

```{r, eval = FALSE, echo = FALSE}
# Create ten_df data frame from vectors
ten_df <- data.frame(id, sex, height, weight, tall_180, age) 
```
