...
<img src="image/baselers_raw.png">
...
<img src="image/rbootcamp_raw.png">
...
<p align="center">
  <img src="image/tab.png" height="80px"></img>
</p>
...
<img src="image/auto_complete_3.png"></img>
...
1 - <high>Find the file</high> on your harddrive. Should be in your data folder inside your project.

2 - <high>Open the file</high> in a text viewer, e.g., *TextEdit* (Mac), *TextWranger* (Mac), *WordPad* (Windows).
<br><br><br><br>
<img src="image/find_data.png">
...
a) <high>removing character elements</high> from otherweise numeric variables.<br><br2>
